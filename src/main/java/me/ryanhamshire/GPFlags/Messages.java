...
public enum Messages {
    ...
    DisableNoEnderPearl,
    NoEnderPearlInClaim,
    EnableNoCreatingFire,
    DisableNoCreatingFire,
    NoEnderPearlToClaim,
    NoEnderPearlInWorld,
    EnableNoMcMMOSkills,
    ...
    EnterFlightEnabled,
    RequireEmptyInvOnEnterEnabled,
    RequireEmptyInvOnEnterDisabled,
    RequireEmptyInvOnEnterDenied,
    SnowballsAlwaysDropEnabled,
    SnowballsAlwaysDropDisabled,
    EnabledNoTakingFromItemFrames,
    DisabledNoTakingFromItemFrames,
    NoTakingFromItemFrames,
    EnabledNoDamagePlayerSameClaim,
    DisabledNoDamagePlayerSameClaim,
    NoDamagePlayerSameClaim,
    EnabledSnowballInstaKills,
    DisabledSnowballInstaKills,
    ExitFlightDisabled,
    AllowFlyForEveryoneEnabled,
    AllowFlyForEveryoneDisabled,
    ...
    PlayerGamemode,
    EnableNoVineGrowth,
    EnabledPublicContainerStackLimit,
    DisabledPublicContainerStackLimit,
    EnabledNoBreakCertainBlock,
    DisabledNoBreakCertainBlock,
    EnabledNoPlaceCertainBlock,
    DisabledNoPlaceCertainBlock,
    NoBreakCertainBlockMessage,
    NoPlaceCertainBlockMessage,
    DisableNoVineGrowth,
    EnableNoSnowForm,
    DisableNoSnowForm,
    EnableNoIceForm,
    ...
    EnabledNoSittingAnimals,
    DisabledNoSittingAnimals,
    NoSittingAnimals,
